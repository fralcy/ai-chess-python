...
class PauseMenu:
    ...
    def draw(self):
        ...
        panel_height = self.screen_height * 0.4
        ...
        # Draw title text
        title_surface = self.title_font.render("Restart game?", True, self.TEXT_COLOR)
        title_rect = title_surface.get_rect(center=(self.screen_width // 2, self.screen_height // 2 - 40))
